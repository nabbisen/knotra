//! RFC-0012 — Command palette: entry building and fuzzy search.
...
pub fn dispatch_entry(state: &AppState) -> Option<crate::message::Message> {
    ...
    match entry.kind {
        PaletteEntryKind::Action => match entry.payload.as_str() {
            ...
            "action.workspace_create" => Some(Message::Workspace(
                crate::message::WorkspaceMessage::CreateWorkspaceDialogOpened,
            )),
